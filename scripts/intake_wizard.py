...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--setup-global", action="store_true", help="Save global UI preferences only; do not create or update project config.")
...
def build_config(args: argparse.Namespace) -> PaperSpineConfig | None:
    ...
    if args.setup_global:
        print(f"{tr(ui_language, 'wrote')} {global_config_path()}")
        return None
