...
section. Resolve `<SKILL_DIR>` to the directory containing the loaded `SKILL.md`,
then validate from the project directory with:

```text
python "<SKILL_DIR>/scripts/results_validation_check.py" paper_rewriting_output --markdown --write
```
